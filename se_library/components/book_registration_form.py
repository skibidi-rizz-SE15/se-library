...
def book_details() -> rx.Component:
    return rx.cond(
        ...
        rx.grid(
            ...
            book_slot(id=1, title=BookRegistrationPageState.title, authors=BookRegistrationPageState.get_formatted_authors, image_src=BookRegistrationPageState.cover_image_link, class_name="w-full"),
            rx.grid(
