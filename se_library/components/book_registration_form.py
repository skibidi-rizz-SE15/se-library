...
def book_details() -> rx.Component:
    return rx.cond(
        ...
        rx.grid(
            ...
            book_slot(isbn13=BookRegistrationPageState.isbn13, title=BookRegistrationPageState.title, authors=BookRegistrationPageState.authors, image_src=BookRegistrationPageState.cover_image_link, class_name="w-full h-fit"),
            rx.grid(
