...
def book_details_mobile_tablet() -> rx.Component:
    return rx.flex(
        rx.text(f"Practical Object-Oriented Design with UML (UK Higher Education Computing Computer Science)", class_name="font-semibold font-Varela text-sm text-center", trim="normal"),
